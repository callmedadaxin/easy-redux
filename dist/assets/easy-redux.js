...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.setCentralRequest = exports.combinceReducer = exports.initReducers = exports.hotReload = exports.createStore = exports.connect = undefined;
	...
	Object.defineProperty(exports, 'createStore', {
	  enumerable: true,
	  get: function get() {
	    return _connect.createStore;
	  }
	});
	Object.defineProperty(exports, 'hotReload', {
	  enumerable: true,
	  get: function get() {
	    return _connect.hotReload;
	  }
	});
	
	var _reducer = __webpack_require__(25);
	
	Object.defineProperty(exports, 'initReducers', {
	  enumerable: true,
	  get: function get() {
	    return _reducer.initReducers;
	  }
	});
	Object.defineProperty(exports, 'combinceReducer', {
	  enumerable: true,
	  get: function get() {
	    return _reducer.combinceReducer;
	  }
	});
	
	var _request = __webpack_require__(26);
	
	var setCentralRequest = exports.setCentralRequest = function setCentralRequest(fn, handleResponse, handleError) {
	  Object.assign(_request.centralRequest, {
	    fn: fn,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $$observable = _interopDefault(__webpack_require__(62));
...
/***/ (function(module, exports) {
	...
	var splitObject = exports.splitObject = function splitObject(obj, keys) {
	  var ret = {};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.combinceReducer = exports.initReducers = undefined;
	
	var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
	
	var _redux = __webpack_require__(13);
	
	var _spaceStore = __webpack_require__(27);
	
	var _spaceStore2 = _interopRequireDefault(_spaceStore);
	 ...
	 */
	var handleFetchReducers = function handleFetchReducers(reducersConfig) {
	  var _extends2;
	
	  if (!reducersConfig.fetch) return reducersConfig;
	
	  var inititalState = reducersConfig.state,
	      reducers = reducersConfig.reducers,
	      fetch = reducersConfig.fetch;
	
	  var FETCH_SUCCESS = fetch + 'Success';
	  var FETCH_FAILED = fetch + 'Failed';
	
	  if (!(0, _util.isObj)(inititalState)) {
	    throw '对于fetch类型reducer, state必须是一个对象！';
	  }
	
	  // 自动注入loading, error状态，并进行处理
	  var retReducers = _extends({}, reducers, (_extends2 = {}, _defineProperty(_extends2, fetch, function (state, payload) {
	    var ret = _extends({}, state, {
	      loading: true,
	      error: false
	    });
	    return reducers[fetch] ? reducers[fetch](ret, payload) : ret;
	  }), _defineProperty(_extends2, FETCH_SUCCESS, function (state, payload) {
	    var ret = _extends({}, state, {
	      loading: false
	    });
	    return reducers[FETCH_SUCCESS] ? reducers[FETCH_SUCCESS](ret, payload) : ret;
	  }), _defineProperty(_extends2, FETCH_FAILED, function (state, error) {
	    var ret = _extends({}, state, {
	      loading: false,
	      error: error
	    });
	 ...
	 */
	var initReducers = exports.initReducers = function initReducers(reducersConfig, namespace) {
	  // 优先添加fetch处理
	  var config = handleFetchReducers(reducersConfig);
	  var inititalState = config.state,
	      reducers = config.reducers;
	
	
	  var actionNames = Object.keys(reducers);
	
	  var resultActions = actionNames.map(function (action) {
	    var childNamespace = namespace + '/' + action;
	    // 将action存入namespace
	    _spaceStore2.default.setActionByNamespace(childNamespace);
	
	    return {
	      name: _spaceStore2.default.toAction(childNamespace),
	      fn: reducers[action]
	    };
	  });
	  ...
	  return function () {
	    ...
	    var actionFn = resultActions.find(function (cur) {
	      return cur.name === action.type;
	    });
	    if (actionFn) {
	 ...
	 */
	var combinceReducer = exports.combinceReducer = function combinceReducer(reducers, namespace) {
	  var reducerMap = {};
	  var reducerNames = Object.keys(reducers);
	
	  var getReducerMap = function getReducerMap(namespace) {
	    reducerNames.forEach(function (name) {
	      var reduce = reducers[name];
	      var childNamespace = namespace === '/' ? '/' + name : namespace + '/' + name;
...
/***/ (function(module, exports) {
	...
	var centralRequest = exports.centralRequest = {
	  fn: fetch,
...
/***/ (function(module, exports) {
	...
	exports.default = {
	  ...
	  setActionByNamespace: function setActionByNamespace(namespace) {
	    var action = this.toAction(namespace);
	    this.namespaces[namespace] = action;
	  },
	  get: function get(key) {
	    return this.namespaces[key];
	  },
	  toAction: function toAction(namespace) {
	    var ret = namespace;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.splitAndInitActions = undefined;
	...
	var request = _request.centralRequest.fn,
	    handleResponse = _request.centralRequest.handleResponse,
	    handleCentralError = _request.centralRequest.handleError;
	/**
	 * action转化
	...
	var initAction = function initAction(action) {
	  return function (params) {
	    return function (dispatch, getstate) {
	      var retDispatch = function retDispatch(namespace, payload) {
	        // 处理异步情况
	        if ((0, _util.isObj)(namespace)) {
	          var url = namespace.url,
	              _params = namespace.params,
	              _action = namespace.action,
	              handleResult = namespace.handleResult,
	              handleError = namespace.handleError;
	
	          dispatch({
	            type: _spaceStore2.default.get(_action),
	            payload: _params
	          });
	          return request(url, _params).then(handleResponse).catch(handleCentralError).then(function (json) {
	            var ret = handleResult(json);
	            dispatch({
	              type: _spaceStore2.default.get(_action + 'Success'),
	              payload: ret
	            });
	            return ret;
	          }).catch(function (error) {
	            var err = handleError(error);
	            dispatch({
	              type: _spaceStore2.default.get(_action + 'Failed'),
	              payload: err
	            });
	            return err;
	          });
	        ...
	        return dispatch({
	          type: _spaceStore2.default.get(namespace),
	          payload: payload
	        });
	      };
	 ...
	 */
	var splitAndInitActions = exports.splitAndInitActions = function splitAndInitActions(actions, keys) {
	  return keys.reduce(function (retActions, key) {
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var connect = exports.connect = function connect(fn, actions) {
	  var mapStateToProps = function mapStateToProps(state) {
	    return fn(state, _util.splitObject);
	  };
	  var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    var resultActions = actions(dispatch, _action.splitAndInitActions);
	    return (0, _redux.bindActionCreators)(resultActions, dispatch);
	  };
	 ...
	 */
	var createStore = exports.createStore = function createStore(appReducer, inititalState) {
	  var middlewares = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
	
	  var retMiddlewares = [_reduxThunk2.default].concat(_toConsumableArray(middlewares));
	
	  if (typeof appReducer !== 'function') {
	    appReducer = (0, _reducer.combinceReducer)(appReducer, '/');
	  }
	
	  return (0, _redux.createStore)(appReducer, inititalState, _redux.applyMiddleware.apply(undefined, _toConsumableArray(retMiddlewares)));
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReactBaseClasses = __webpack_require__(30);
...
/***/ (function(module, exports, __webpack_require__, __webpack_module_template_argument_0__, __webpack_module_template_argument_1__, __webpack_module_template_argument_2__, __webpack_module_template_argument_3__, __webpack_module_template_argument_4__, __webpack_module_template_argument_5__) {
	...
	var ReactPropTypesSecret = __webpack_require__(__webpack_module_template_argument_4__);
	var checkPropTypes = __webpack_require__(__webpack_module_template_argument_5__);
